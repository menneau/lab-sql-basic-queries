...
SELECT COUNT(*) AS StoreidCounts FROM store;
-- 5.2 Determine the number of employees that the company has:
SELECT COUNT(*) AS number_of_employees FROM staff;
-- 5.3 Determine how many films are available for rent and how many have been rented:
SELECT 
    COUNT(*) AS number_of_physical_movies_available,
    COUNT(DISTINCT inventory.film_id) AS distinct_film_titles_for_rent
FROM inventory
...
SELECT COUNT(*) AS number_of_films_behind_the_scenes FROM film
